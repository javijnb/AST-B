...
public class NoticiaStub extends org.apache.axis2.client.Stub {
    ...
    public noticia.GetTitularResponse getTitular(
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    noticia.GetTitularResponse.class);

            return (noticia.GetTitularResponse) object;
    ...
    public noticia.GetDescripcionResponse getDescripcion(
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    noticia.GetDescripcionResponse.class);

            return (noticia.GetDescripcionResponse) object;
        } catch (org.apache.axis2.AxisFault f) {
            org.apache.axiom.om.OMElement faultElt = f.getDetail();
    ...
    public noticia.GetUrlResponse getUrl(noticia.GetUrl getUrl51)
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    noticia.GetUrlResponse.class);

            return (noticia.GetUrlResponse) object;
        } catch (org.apache.axis2.AxisFault f) {
            org.apache.axiom.om.OMElement faultElt = f.getDetail();
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        org.apache.axiom.soap.SOAPFactory factory, noticia.GetTitular param,
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    noticia.GetTitular.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        org.apache.axiom.soap.SOAPFactory factory, noticia.SetTitular param,
        boolean optimizeContent, javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    noticia.SetTitular.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        noticia.SetDescripcion param, boolean optimizeContent,
        ...
        try {
            ...
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    noticia.SetDescripcion.MY_QNAME, factory));
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        org.apache.axiom.soap.SOAPFactory factory,
        noticia.GetDescripcion param, boolean optimizeContent,
        javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(
                    noticia.GetDescripcion.MY_QNAME, factory));
    ...
    /* methods to provide back word compatibility */
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        org.apache.axiom.soap.SOAPFactory factory, noticia.GetUrl param,
        boolean optimizeContent, javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(noticia.GetUrl.MY_QNAME,
                    factory));
    ...
    /* methods to provide back word compatibility */
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        org.apache.axiom.soap.SOAPFactory factory, noticia.SetUrl param,
        boolean optimizeContent, javax.xml.namespace.QName elementQName)
        throws org.apache.axis2.AxisFault {
        try {
            org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
            emptyEnvelope.getBody()
                         .addChild(param.getOMElement(noticia.SetUrl.MY_QNAME,
                    factory));
